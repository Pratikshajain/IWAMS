# Input_CM= "C:\Users\Pratiksha\.qgis2\python\plugins\iwams\Conservation_Module\Input"
# Output_CM= "C:\Users\Pratiksha\.qgis2\python\plugins\iwams\Conservation_Module\Output_CM"
# suitability_threshold=0.8;
# CM="All"
#CM= 'contour_bunding';
...
slop_file = sys.argv[2]
flow_acc_file = sys.argv[3]
soil_texture_file = sys.argv[4]
land_use_file = sys.argv[5]
aquifer_file = sys.argv[6]
boundry_file = sys.argv[7]
paremeter_file = sys.argv[8]
output_folder = sys.argv[9]
choose_measure = sys.argv[10]
print(choose_measure)
suitable_thresh = sys.argv[11]
